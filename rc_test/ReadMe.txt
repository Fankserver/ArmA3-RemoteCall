========================================================================
    KONSOLENANWENDUNG: rc_test-Projektübersicht
========================================================================

Diese rc_test-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre rc_test-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen rc_test.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
